...
use Awz\Quickmail\Access\Custom\ComponentConfig;
                ...
                window.awz_right_dialog = {
                    ...
                    reloadItems: function(items, event){
                        ...
                        items.forEach(function(itm){
                            if(itm.getEntityId()==='user' || itm.getEntityType()==='awzquickmail-user'){
                                let itmEv = {
                                    type: 'users',
                                    id: 'U'+itm.getId(),
                                    key: 'U'+itm.getId(),
                            ...
                            }else if(itm.getEntityType()==='awzquickmail-group'){
                                let itmEv = {
                                    type: 'groups',
                                    id: 'G'+itm.getId(),
                                    key: 'G'+itm.getId(),
                    ...
                    load: function(groupKey, options){
                        ...
                        if(groupData.hasOwnProperty('members')){
                            for(k in groupData['members']){
                                ...
                                if(itm.type==='users'){
                                    preselectedItems.push(['awzquickmail-user',itm.id]);
                                }
                                else if(itm.type==='awzquickmail-user'){
                                    preselectedItems.push(['awzquickmail-user',itm.id]);
                                }
                                else if(itm.type==='awzquickmail-group'){
                                    preselectedItems.push(['awzquickmail-group',itm.id]);
                                }
                        ...
                        this.dialog = new BX.UI.EntitySelector.Dialog({
                            ...
                            entities: [
                                {
                                    id: 'awzquickmail-user',
                                    options: {},
                                    dynamicLoad: true,
                                    dynamicSearch: true,
                                },
                                {
                                    id: 'awzquickmail-group',
                                    options: {},
                                    dynamicLoad: true,
                                    dynamicSearch: true,
                                },
